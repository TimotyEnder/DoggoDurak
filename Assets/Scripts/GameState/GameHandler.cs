...
public class GameHandler : MonoBehaviour
{
    ...
    public void Heal(int amount) //any healing effects should be handled by this
    {
    ...
    public void Damage(int amount) //any effects damaging the enemy should go through this
    {
