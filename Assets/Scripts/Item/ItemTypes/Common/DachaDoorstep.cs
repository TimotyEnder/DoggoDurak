...
public class DachaDoorstep : Item
{
    public override void InitItem()
    {
        ...
        this.toolTipDesc = "3 random cards gain "+StylisticClass.BounceColor+StylisticClass.BounceString+" (When defending, this card does  damage  equal  to the difference of values between the defending and defended cards,)";
    }
