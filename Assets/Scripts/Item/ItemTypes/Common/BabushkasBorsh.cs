...
public class BabushkasBorsh : Item
{
    public override void InitItem()
    {
        ...
        this.toolTipDesc = "3 random cards gain "+StylisticClass.RestoringColor+StylisticClass.RestoringString+"(Defend with this card to gain health equal to the difference of values between the defending and defended cards,)</color>";
    }
