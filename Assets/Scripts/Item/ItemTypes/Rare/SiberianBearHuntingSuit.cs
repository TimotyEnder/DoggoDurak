...
public class SiberianBearHuntingSuit : Item
{
    public override void InitItem()
    {
        ...
        this.toolTipDesc = "Odd numbered cards gain "+StylisticClass.SpikyColor+StylisticClass.SpikyString+" 1(When this card is defended deal 1 damage for each spiky modifier of the card to the defending player.)</color>";
    }
