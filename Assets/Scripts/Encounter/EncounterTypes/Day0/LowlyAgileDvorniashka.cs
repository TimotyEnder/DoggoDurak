...
using UnityEngine;
[CreateAssetMenu(fileName = "LowlyAgileDvorniashka", menuName = "Encounters/Day0/LowlyAgileDvorniashka")]
public class LowlyAgileDvorniashka : Encounter
{
    public override void InitEncounter()
    {
        ...
        boss = false;
        day = 0;
        description = "A lowly but agile Dvorniashka that uses parry to avoid damage.";
    }
