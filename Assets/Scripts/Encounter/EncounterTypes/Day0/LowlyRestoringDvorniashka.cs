...
using UnityEngine;
[CreateAssetMenu(fileName = "LowlyRestoringDvorniashka", menuName = "Encounters/Day0/LowlyRestoringDvorniashka")]
public class LowlyRestoringDvorniashka: Encounter
{
    public override void InitEncounter()
    {
        encounterName = "Lowly Restoring Dvorniashka";
