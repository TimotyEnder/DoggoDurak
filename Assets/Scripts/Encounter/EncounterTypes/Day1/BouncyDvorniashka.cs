...
using UnityEngine;
[CreateAssetMenu(fileName = "BouncyDvorniashka", menuName = "Encounters/Day1/BouncyDvorniashka")]
public class BouncyDvorniashka : Encounter
{
    public override void InitEncounter()
    {
        encounterName = "Bouncy Dvorniashka";
